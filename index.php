...
<header style="width: 1500px">
	<div id="a">
		...
		<a class="active" href="index.php"><li>Home</li></a>
			<a href="aadhar.php"><li>Aadhar Card No.</li></a>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="image1.jpg" alt="rashon" style="width:1700px; height: 900px;">
      </div>

      <div class="item">
        <img src="image2.jpg" alt="bhamasha" style="width:1700px; height: 900px;">
      </div>
    
      <div class="item">
        <img src="image.jpg" alt="aadhar Card" style="width:1700px; height: 900px;">
      </div>
    </div>
